...
| ---- | ---- | ---- | ---- | ---- |
| スキーム名（プロトコル）　 | ホスト名 | ドメイン名 | パス名（ディレクトリ） | ファイル名|
...
___
### リクエストヘッダ
Webコンテンツの伝送に用いられるHTTPで、クライアントからサーバへの要求であるHTTPリクエストの前半にある制御情報を記した領域のこと。要求内容の詳細を記述する。
___
